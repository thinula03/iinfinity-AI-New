    ...
    if (!empty($_POST)) {
        ...
        if ($valid_post) {
            ...
            if (!$valid_name) {
                ...
                include_once '../backend/mitigrator.php';
                ...
                include_once '../backend/user_data.php';
                $db = new User_Data();
                $db->connect();
